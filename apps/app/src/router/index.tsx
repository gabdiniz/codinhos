...
const AvatarStudioPage = lazy(() => import('../pages/student/AvatarStudioPage.tsx'))
    ...
    children: [
      ...
      // -- Area do aluno (layout route) -----------------------------------------
      {
        ...
        children: [
          ...
          {
            path: 'avatar',
            element: <Page component={AvatarStudioPage} />,
          },
          {
            path: 'ranking',
      ...
      // -- Area do gestor (layout route) ----------------------------------------
      {
        ...
        children: [
          ...
          {
            path: 'manager/professors',
            element: <Page component={ProfessorsPage} />,
          },
          {
